...
/**********************************************************************
 * An implementation of a Pair structure.
 *
 * This custom data type allows to store two unsigned int values.
 **********************************************************************/
typedef struct pair
{
  unsigned int left;
...
/**********************************************************************
 * An implementation for the Tripartition procedure.
 *
 * This function partitions an input array in three parts,
 * the central one containing all repeated instances of the
 * pivot value.
 *
 * @param A is the input array to be sorted.
 * @param i is the left input index.
 * @param j is the right input index.
 * @param p is the pivot index.
 * @param elem_size is the type size in bytes of the elements in A.
 * @param leq is the total order to be satisfied by the sorting.
 **********************************************************************/
